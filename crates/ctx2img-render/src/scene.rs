...
use ctx2img_index::handles::HandleRegistry;
use ctx2img_index::workspace::Built;
use ctx2img_layout::rect::{squarify, RectBox};
use ctx2img_layout::{layout, LayoutOptions, SavedSites, Territory};
...
pub struct Scene {
    ...
    pub contours: Vec<ctx2img_layout::ContourLevel>,
...
pub fn build_l2(
    ...
    let cells: Vec<CellVis> = shown
        ...
        .map(|(ci, &fi)| {
            ...
            let mut syms: Vec<&ctx2img_core::Symbol> = a.parsed[fi].symbols.iter().collect();
